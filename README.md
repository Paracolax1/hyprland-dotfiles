...
I just forked this from https://github.com/saatvik333/niri-dotfiles/tree/main
and have basically changed nothing except adding an install script generated by chatgpt, use at your own risk.

## Installation Guide

The installation script assumes a clean Arch-Linux installation, aka intended to setup a whole desktop stack not just the requirements for these dotfiles.

```bash
curl -fsSL https://raw.githubusercontent.com/Paracolax1/hyprland-dotfiles/refs/heads/main/install.sh -o install.sh
chmod +x install.sh
./install.sh
```
...
> If you find this project helpful, please consider starring **THE** **ORIGINAL** repository to show your support and help others discover it.
